...
const Projects = () => {
  ...
  return (
    <div id="projects" ref={container} className="relative bg-blue-50 dark:bg-gray-900 font-sans overflow-hidden transition-colors duration-500">
      {/* Section Header */}
      <div className="section-header relative text-center pt-20 pb-10 z-20 px-4 md:px-8">
        <h2 className="text-4xl md:text-5xl lg:text-6xl text-[#4e45d5] dark:text-blue-300 font-display font-bold mb-6">
          My Projects
        </h2>
      ...
      <div className="split-scroll-container relative max-w-7xl mx-auto mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 px-4 md:px-8">
        ...
        <div className="left-column">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <h3 className="animated-text text-3xl md:text-4xl font-bold text-[#343d38] dark:text-white mb-6">
                {project.title}
              </h3>
              <p className="animated-text text-gray-700 dark:text-gray-200 mb-8 leading-relaxed text-base md:text-lg">
                {project.description}
              </p>
              <div className="animated-text flex flex-wrap gap-3 mb-8">
                {project.technologies.map((tech, techIndex) => (
                  <span key={techIndex} className="relative px-4 py-2 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 text-[#343d38] dark:text-gray-100 rounded-full text-sm font-semibold border border-gray-200 dark:border-gray-600 shadow-sm">
                    {tech}
                  </span>
                ))}
              </div>
              <div className="animated-text flex flex-col sm:flex-row gap-4">
                ...
                <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="flex-1 group/btn relative px-4 py-3 bg-gradient-to-r from-gray-800 to-black dark:from-gray-700 dark:to-gray-900 text-white rounded-xl font-semibold text-center transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                  🔗 GitHub
                </a>
              </div>
            </div>
        ...
        <div className="right-column hidden lg:block h-screen">
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="relative w-full max-w-2xl h-auto rounded-3xl shadow-2xl border-8 border-white/80 dark:border-gray-700 bg-gray-200 dark:bg-gray-800 aspect-video">
              {projects.map((project) => (
                <div
      ...
      <div className="cta-section relative bg-blue-50 dark:bg-gray-900 text-center py-20 transition-colors duration-500">
        <h3 className="text-3xl md:text-4xl font-display text-[#4e45d5] dark:text-blue-300 mb-4">Explore More</h3>
        <p className="text-lg text-[#343d38] dark:text-gray-200 mb-8">Visit my GitHub to see all my projects and contributions.</p>
        <a
